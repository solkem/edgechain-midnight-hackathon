...
├── arduino/                        # IoT Device Firmware
│   └── edgechain_iot/
│       └── edgechain_iot.ino       # Arduino Nano 33 BLE Sense
│
├── ipfs-service/                   # Decentralized Storage
│   ├── index.mjs                   # Express microservice
│   ├── fly.toml                    # Fly.io deployment config
│   └── package.json
│
├── packages/
│   ├── contract/                   # Midnight Smart Contracts
│   │   ├── src/
│   │   │   ├── edgechain.compact           # FL contract
│   │   │   ├── arduino-iot.compact         # IoT contract (DEPLOYED)
│   │   │   ├── arduino-iot-private.compact # Enhanced IoT contract
...
│       ├── src/
│       │   ├── providers/
│       │   │   ├── WalletProvider.tsx      # Lace wallet
│       │   │   └── ContractProvider.tsx
│       │   ├── components/
│       │   │   ├── FLDashboard.tsx         # FL training UI
│       │   │   └── ArduinoDashboard.tsx    # IoT dashboard
│       │   └── fl/
│       │       ├── training.ts             # TensorFlow.js
│       │       ├── aggregation.ts          # FedAvg
│       │       └── arduinoIntegration.ts   # BLE integration
│       └── package.json
│
├── server/                         # FL Aggregation Backend
│   ├── src/
│   │   ├── routes/
│   │   │   ├── aggregation.ts
│   │   │   └── arduino.ts                  # IoT registry
│   │   ├── services/
│   │   │   ├── zkProofService.ts
│   │   │   ├── deviceAuth.ts
│   │   │   ├── nullifierTracking.ts
...
│
├── gateway/
│   └── ble_receiver.html           # BLE testing page
│
├── private-docs/                   # Technical documentation
│   ├── IMPLEMENTATION_STATUS.md
│   ├── ARDUINO_RAW_BOARD_ONBOARDING.md
│   ├── ARDUINO_DEVICE_REGISTRATION.md
│   └── ARDUINO_TOOLCHAIN_FIX.md
│
├── ZK_IOT_PROOF.md                 # ZK proof guide
├── turbo.json
├── package.json
└── README.md
```
